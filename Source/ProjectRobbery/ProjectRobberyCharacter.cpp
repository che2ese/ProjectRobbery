...
AProjectRobberyCharacter::AProjectRobberyCharacter()
{
...
void AProjectRobberyCharacter::BeginPlay()
{
    Super::BeginPlay();

    FMT_ERROR(TEXT("Format log test"));
}

void AProjectRobberyCharacter::Tick(float DeltaSeconds)
{
