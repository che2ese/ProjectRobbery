...
void AProjectRobberyPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("SetDestination", IE_Pressed, this, &AProjectRobberyPlayerController::OnSetDestinationPressed);
	InputComponent->BindAction("SetDestination", IE_Released, this, &AProjectRobberyPlayerController::OnSetDestinationReleased);
